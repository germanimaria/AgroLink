...
O **AgroLink** é um protótipo funcional de plataforma digital criado com o propósito de modernizar e fortalecer o comércio local de alimentos. Ele encurta a distância entre quem produz e quem consome, integrando de forma inteligente a tecnologia com práticas eco-agroambientais.

Ao eliminar intermediários desnecessários na cadeia de distribuição, o ecossistema garante:
* Lucro mais justo para o trabalhador do campo.
* Alimentos mais frescos e acessíveis na mesa das famílias na cidade.
* Redução do desperdício logístico e da emissão de poluentes.

---

## 2. Objetivos

* **Conexão Direta:** Unir pequenos e médios produtores rurais a feirantes, mercados locais e consumidores finais.
* **Autonomia Financeira:** Devolver o controle comercial ao produtor, reduzindo a dependência de atravessadores.
* **Educação Ambiental:** Conscientizar o mercado urbano sobre os benefícios ecológicos do consumo local e da agricultura sustentável.
...
O desenvolvimento do front-end priorizou a acessibilidade, a clareza visual e a responsividade (adaptável para celulares e computadores), utilizando as tecnologias:
...
Este projeto foi idealizado, planejado e programado pelos estudantes:
* Maria Julia C.G.
* Manuela C.C.
* Franchesca E.V.
* Maria Izabel D.C.
